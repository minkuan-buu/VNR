...
const sections = [
  ...
  },
  {
    ...
    description:
      ...
      image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8b/Saigon_-_Les_Quais.jpg/1200px-Saigon_-_Les_Quais.jpg",
  },
  {
    title: "Thực hiện đường lối Đại hội XII các nghị quyết",
    description:
      ...
      image: "https://www.historicvietnam.com/wp-content/uploads/2015/03/XX-scaled.jpg",
  },
  {
    ...
    image: "https://uploads.nguoidothi.net.vn/content/267ab78a-ede6-43ad-be24-ee42a1697011.jpg",
  },
];
    ...
    <div className="relative flex flex-col">
      ...
      {sections.map((section, index) => (
        ...
        >
          ...
          <h2 className="text-3xl text-gray-300 mt-2 bg-black bg-opacity-50 p-2 rounded-lg">{section.subtitle}</h2>
